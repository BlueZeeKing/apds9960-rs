    ...
    I2C: i2c::I2c<Error = E>,
{
    ...
    pub fn enable_gesture(&mut self) -> Result<(), E> {
        self.set_flag_enable(Enable::GEN, true)
    }

    /// Disable gesture detection
    pub fn disable_gesture(&mut self) -> Result<(), E> {
    ...
    pub fn enable_gesture_mode(&mut self) -> Result<(), E> {
